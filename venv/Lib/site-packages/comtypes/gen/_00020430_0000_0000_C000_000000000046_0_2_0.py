...
IFontDisp = Font
__all__ = [ 'FONTSTRIKETHROUGH', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_HIMETRIC', 'FONTITALIC',
           'Font', 'Unchecked', 'Checked', 'OLE_OPTEXCLUSIVE',
           'FontEvents', 'FONTNAME', 'FONTUNDERSCORE', 'FONTSIZE',
           'OLE_XSIZE_CONTAINER', 'OLE_TRISTATE', 'OLE_XPOS_HIMETRIC',
           'IFont', 'OLE_XPOS_PIXELS', 'IPictureDisp', 'Color',
           'OLE_XSIZE_PIXELS', 'OLE_YSIZE_CONTAINER',
           'OLE_CANCELBOOL', 'VgaColor', 'StdPicture', 'Picture',
           'Default', 'LoadPictureConstants', 'IFontEventsDisp',
           'OLE_HANDLE', 'OLE_XSIZE_HIMETRIC', 'OLE_COLOR',
           'OLE_YPOS_HIMETRIC', 'IPicture', 'FONTBOLD', 'StdFont',
           'IFontDisp', 'OLE_XPOS_CONTAINER', 'Monochrome',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_PIXELS', 'Gray']
